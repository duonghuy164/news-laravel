                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="admin/slide/edit/{{ $slide->id }}" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <textarea  name="NoiDung" class="form-control ckeditor" rows="3" id="demo">{{ $slide->NoiDung }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Link</label>
                                <input class="form-control" name="link" placeholder="Nhập Links" value="{{ $slide->link }}" />
                            </div>
                            <div class="form-group">
